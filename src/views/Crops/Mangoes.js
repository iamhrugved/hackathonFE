  ...
  return (
    <div style={{ display: "flex" }}>
      <div style={{ flex: 1 }}>
        ...
        <span style={{ marginTop: "5px" }}><b>Philippines</b></span><br/>
        <span style={{ marginTop: "5px" }}><b>Philippines, the largest production areas are Pangasinan in Luzon, West and Central Visas, Davao Region, and Cotabato Province for Mindanao</b></span>
      </div>
      <div style={{ marginLeft: "20px" }}>
        ...
        <span style={{ marginTop: "5px" }}><b>India</b></span><br/>
        <span style={{ marginTop: "5px" }}><b>The major growing regions are Andhra Pradesh</b></span>
      </div>
    </div>
  );
}
