  ...
  return (
    <div style={{ display: "flex" }}>
      <div style={{ flex: 1 }}>
        ...
        <span style={{ marginTop: "5px" }}><b>China</b></span><br/>
        <span style={{ marginTop: "5px" }}><b>Most bananas are grown in the south, mainly in Guandong,
Guangxi, Yunnan, and Hainan</b></span>
      </div>
      <div style={{ marginLeft: "20px" }}>
        ...
        <span style={{ marginTop: "5px" }}><b>Indonesia</b></span><br/>
        <span style={{ marginTop: "5px" }}><b>The major growing regions are Lampung, East Java, and West Java. Indonesian Papua in the east Indonesia</b></span>
      </div>
    </div>
  );
}
